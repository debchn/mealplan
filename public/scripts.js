...
mealPlan.nonHumanFood = ["anti-perspirant", "bathroom", "batteries", "body wash", "candle", "cat food", "conditioner", "crest", "cup of soup", "delissio", "dentyne", "detergent", "dial", "diapers", "dishwashing", "dog food", "foil", "garbage", "gilette", "hair care", "head & shoulders", "herbal essences", "lean cuisine", "litter", "lubriderm", "pads", "pampers", "paper towel", "poinsettia", "q-tips", "shampoo", "shower", "snack bars", "snuggle", "soap", "sunsilk", "sunlight", "superfries", "tampons", "tissue", "toilet", "toothbrush", "toothpaste", "vaseline", "vitamins", "whiskas", "ziploc"];
